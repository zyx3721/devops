...
- [五、环境变量配置说明](#五环境变量配置说明)
  - [5.1 服务器配置](#51-服务器配置)
  - [5.2 MySQL 配置](#52-mysql-配置)
  - [5.3 Redis 配置](#53-redis-配置)
  - [5.4 Jenkins 配置](#54-jenkins-配置)
  - [5.5 Kubernetes 配置](#55-kubernetes-配置)
  - [5.6 飞书配置](#56-飞书配置)
  - [5.7 飞书应用权限配置](#57-飞书应用权限配置)
  - [5.8 飞书 OAuth 授权（按姓名搜索用户）](#58-飞书-oauth-授权按姓名搜索用户)
  - [5.9 JWT 配置](#59-jwt-配置)
- [六、飞书消息发送格式说明](#六飞书消息发送格式说明)
  - [6.1 text（文本消息）](#61-text文本消息)
  - [6.2 post（富文本消息）](#62-post富文本消息)
  - [6.3 interactive（卡片消息）](#63-interactive卡片消息)
- [七、生产环境部署](#七生产环境部署)
  - [7.1 克隆项目](#71-克隆项目)
  - [7.2 后端构建与配置](#72-后端构建与配置)
  - [7.3 前端构建与配置](#73-前端构建与配置)
  - [7.4 配置Nginx反向代理](#74-配置nginx反向代理)
  - [7.5 访问系统](#75-访问系统)
- [八、API 文档](#八api-文档)
  - [8.1 认证与用户管理](#81-认证与用户管理)
  - [8.2 应用管理](#82-应用管理)
  - [8.3 发布管理](#83-发布管理)
  - [8.4 审批管理](#84-审批管理)
  - [8.5 Pipeline 流水线](#85-pipeline-流水线)
  - [8.6 Kubernetes 集群管理](#86-kubernetes-集群管理)
  - [8.7 Jenkins 管理](#87-jenkins-管理)
  - [8.8 告警管理](#88-告警管理)
  - [8.9 健康检查](#89-健康检查)
  - [8.10 通知管理](#810-通知管理)
  - [8.11 安全管理](#811-安全管理)
